...
<div class="container">
    ...
    $cus_username = "SELECT username FROM customer";
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
        ...
        <table class='table table-hover table-responsive table-bordered '>
            <tr>
                ...
                echo "<td>";
                echo '<select class="w-100 fs-5 rounded" name="cus_username">';
            ...
            foreach ($arrayPost_product as $product_row => $product_ID) {
                ...
                echo '<td>
                       <select class="fs-5 " name="product[]">';
                ...
                */
                ...
                echo '</td>';
                echo "<td>";
                echo '<select class="w-100 fs-5 " name="quantity[]" >';
