...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-md-light bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-light" href="home.php">Inventory System</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-light" aria-current="page" href="https://shopee.com.my/shoe_life" target="_blank">Shopee</a>
                    </li>
                    </li>
                ...
                <div class="collapse navbar-collapse d-flex justify-content-end me-5" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown d-flex">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                <!-- <li><a class="dropdown-item" href="admin_update.php?id=<?php echo $username ?>">Edit Profile</a></li> -->
