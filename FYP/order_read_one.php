...
<body>
    ...
    <div class="container">
        ...
        try {
            ...
            $query2 = "SELECT order_summary.order_id, order_summary.username, customer.first_name, customer.last_name, customer.username
            FROM order_summary  
            INNER JOIN customer 
            ON order_summary.username= customer.username 
